...
var ZestyExplorerBrowser = function ZestyExplorerBrowser(_ref) {
  ...
  var content = contentData || index.dummydata; // const [modal, setModal] = React.useState(false);
  ...
  var flaten1 = helper.flattenObj(content); // convert to array of objects

  var flaten2 = helper.convertToArray(flaten1); // generate columns for search
